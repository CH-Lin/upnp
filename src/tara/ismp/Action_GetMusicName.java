...
public class Action_GetMusicName implements UPnPAction {

	final private String NAME = "GetMusicName";
	final private String RET_TARGET_VALUE = "RetMusicName";
	final private String[] OUT_ARG_NAMES = new String[]{RET_TARGET_VALUE};
	private UPnPStateVariable state;
	private MusicModel model;
	
	
	public Action_GetMusicName(MusicModel model,UPnPStateVariable state){
		this.state = state;
		this.model=model;
	}
	...
	public Dictionary invoke(Dictionary args) throws Exception {
		String target = model.getMusicName();
		Hashtable<String,String> result = new Hashtable<String,String>();
		result.put(RET_TARGET_VALUE,new String(target));
		return result;
	}
}
