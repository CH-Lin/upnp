...
public class Variable_MusicName implements UPnPStateVariable {

	final private String NAME = "music";

	final private String DEFAULT_VALUE = "C:"
			+ System.getProperty("file.separator") + "test.wav";

	public Variable_MusicName() {
	}
