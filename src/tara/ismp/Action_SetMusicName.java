...
public class Action_SetMusicName implements UPnPAction {

	final private String NAME = "SetMusicName";
	final private String NEW_TARGET_VALUE = "Music Name(*.wav)";
	final private String[] IN_ARG_NAMES = new String[]{NEW_TARGET_VALUE};
	private UPnPStateVariable state;
	private MusicModel model;
	
	
	public Action_SetMusicName(MusicModel model,UPnPStateVariable state){
		this.state = state;
		this.model=model;
	}
	...
	public Dictionary invoke(Dictionary args) throws Exception {
		String value = (String) args.get(NEW_TARGET_VALUE);
		model.setName(value);
		return null;
	}
}
