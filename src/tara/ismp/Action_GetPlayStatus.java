...
public class Action_GetPlayStatus implements UPnPAction {

	final private String NAME = "GetPlayStatus";
	...
	public Action_GetPlayStatus(MusicModel model, UPnPStateVariable state) {
		this.state = state;
		this.model = model;
	}
	...
	public Dictionary invoke(Dictionary args) throws Exception {
		String status = model.getPlayStatus();
		Hashtable<String, String> result = new Hashtable<String, String>();
		result.put(RESULT_STATUS, new String(status));
		return result;
	}
}
